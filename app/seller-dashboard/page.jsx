...
import { ShoppingBag, Package, TrendingUp, Users, DollarSign, ArrowUpRight, ArrowDownRight, AlertTriangle } from 'lucide-react';
...
export default function SellerDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground mb-1">Store Overview</h1>
        <p className="text-sm text-muted">Welcome back! Here's what's happening with your store today.</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <AnimatedStat label="Active Products" value={products?.filter(p => p.isActive).length || 0} icon={Package} color="#06B6D4" glow="#06B6D4" change={8} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-5">
            ...
            <a href="/seller-dashboard/products" className="text-xs text-primary hover:text-primary-hover transition-colors">View all →</a>
          </div>
          {products.length === 0 ? (
            <div className="text-center py-8 text-muted">No products added yet.</div>
          ) : (
            <div className="space-y-4">
              {products.slice(0, 5).map(product => (
                <div key={product._id} className="flex items-center gap-3">
                  ...
                  <div className="text-xs font-medium px-2 py-1 rounded bg-surface border border-border text-secondary">
                    {product.stock} left
                  </div>
                </div>
              ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-5">
            ...
            <a href="/seller-dashboard/orders" className="text-xs text-primary hover:text-primary-hover transition-colors">View all →</a>
          </div>
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-5">
            ...
            <a href="/seller-dashboard/products" className="text-xs text-primary hover:text-primary-hover transition-colors">Manage →</a>
          </div>
